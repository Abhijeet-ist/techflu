...
export default function SpeakersPage() {
    const speakers = [
        {
            name: "Vivek Sridhar",
            title: "CTO - Microsoft Startup ",
            quote: "The attention to detail here is simply unmatched,",
            image:
                "/S2_c.jpeg",
            stats: {
                linkedin: {
    ...
    return (
        <div className="min-h-screen bg-black px-4 py-8 md:p-12">
          <h1 className="text-2xl md:text-4xl font-bold text-center text-[#ff4500] mb-12 max-w-4xl mx-auto leading-tight">
            Meet the inspiring speakers of TechFluence 2—visionaries, innovators, and tech leaders shaping the future!
          </h1>
