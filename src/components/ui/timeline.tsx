    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
                <h2 className="text-lg md:text-4xl mb-4 font-bold text-orange-500 opacity-75 max-w-4xl">
                    Changelog of TECHFLUENCE
                </h2>
                <p className="text-neutral-500 dark:text-neutral-400 text-sm md:text-base max-w-sm italic leading-relaxed">
