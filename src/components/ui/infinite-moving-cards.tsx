    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            key={idx}
            className="w-[300px] max-w-full relative rounded-2xl border border-gray-800 px-6 py-5 md:w-[400px] text-white hover:scale-105 transition-all duration-300 transform hover:shadow-lg bg-gradient-to-r from-black to-orange-500"
          >
